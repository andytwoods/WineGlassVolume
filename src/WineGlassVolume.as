		...
		public function WineGlassVolume()
		{
			...
			function fileLoadedL(e:Event):void{
				...
				if(image.name.indexOf("_")==-1){
					defaults[image.defaultType] = new Default(image);
					defaultTally ++;
				}
